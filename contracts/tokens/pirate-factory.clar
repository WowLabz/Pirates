...
;; hat 
(define-map common-hat-trait uint (string-utf8 260000))
(define-data-var last-common-hat-id uint u0)
(define-map rare-hat-trait uint (string-utf8 260000))
(define-data-var last-rare-hat-id uint u0)
;; bottom
(define-map common-bottom-trait uint (string-utf8 260000))
(define-data-var last-common-bottom-id uint u0)
(define-map rare-bottom-trait uint (string-utf8 260000))
(define-data-var last-rare-bottom-id uint u0)
;; face
(define-map common-face-trait uint (string-utf8 260000))
(define-data-var last-common-face-id uint u0)
(define-map rare-face-trait uint (string-utf8 260000))
(define-data-var last-rare-face-id uint u0)
;; hand
(define-map common-hand-trait uint (string-utf8 260000))
(define-data-var last-common-hand-id uint u0)
(define-map rare-hand-trait uint (string-utf8 260000))
(define-data-var last-rare-hand-id uint u0)
;; sword
(define-map common-sword-trait uint (string-utf8 260000))
(define-data-var last-common-sword-id uint u0)
(define-map rare-sword-trait uint (string-utf8 260000))
(define-data-var last-rare-sword-id uint u0)
;; top
(define-map common-top-trait uint (string-utf8 260000))
(define-data-var last-common-top-id uint u0)
(define-map rare-top-trait uint (string-utf8 260000))
